...
export interface NupesLogoProps extends React.SVGProps<SVGSVGElement> {
  color?: Colors;
}

const DEFAULT_WIDTH = 824.52338;
const DEFAULT_HEIGHT = 1179.671;

export const LogoNupes: React.FC<NupesLogoProps> = ({
  color,
  width,
  height,
  ...props
  ...
  return (
    <svg
      ...
      viewBox="0 0 824.52338 1179.671"
    ...
    >
      ...
      <g id="g1245" transform="translate(-107.26485,-79.109261)">
        <path
          fill={color ?? "url(#linearGradient58877)"}
        ...
        />
        <path
          fill={color ?? "url(#linearGradient54532)"}
