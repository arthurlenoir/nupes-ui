...
export interface LogoPCFProps extends React.SVGProps<SVGSVGElement> {
  color?: Colors;
}

const DEFAULT_WIDTH = "106.688";
const DEFAULT_HEIGHT = "73.208";

export const LogoPCF: React.FC<LogoPCFProps> = ({
  color,
  width,
  height,
  ...props
  ...
  return (
    ...
    >
      <defs id="defs4">
        <path id="a" d="M 0.25,0.289 H 96.474 V 5.252 H 0.25 Z" />
        <path id="c" d="M 0,0.314 H 57.865 V 61.352 H 0 Z" />
      </defs>
      <g
        fill="none"
        fillRule="evenodd"
        id="g22"
        transform="translate(-7,-6.478)"
      >
        <g transform="translate(17.214,74.435)" id="g11">
        ...
        <g transform="translate(7,6.164)" id="g18">
